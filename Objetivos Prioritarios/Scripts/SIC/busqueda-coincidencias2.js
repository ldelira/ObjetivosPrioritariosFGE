(function ($) {
   ...
   ================================================================ */
        ...
        const encabezado =
            $('<header>')
                ...
                .html(
                    ...
                    '</span>' +
                    '<div>' +
                    '<h2 id="sicModalDetalleTitulo">Detalle de coincidencia</h2>' +
                    '<span id="sicModalDetalleSubtitulo">Información institucional del candidato seleccionado</span>' +
                    '</div>' +
                    '</div>' +
                    '<button type="button" class="sic-modal-detalle-cerrar js-cerrar-detalle-tablet" aria-label="Cerrar detalle">' +
    ...
    function seleccionarCoincidencia(
        ...
        if (esVistaTabletDetalle()) {
            if (abrirDetalle !== false) {
